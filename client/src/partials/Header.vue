      ...
      <div class="flex items-center justify-between h-16 -mb-px">
        ...
        <div class="flex items-center space-x-3">
          <router-link
            to=""
            @click="goBack"
            class="inline-flex text-[12px] items-center px-3 py-1 mb-1 mt-2 text-sm font-medium text-center text-white bg-red-500 text-bold rounded focus:ring-4 focus:outline-none"
          >
