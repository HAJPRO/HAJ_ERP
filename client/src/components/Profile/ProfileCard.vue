...
<template>
  <div
    class="overflow-hidden mt-3 rounded-sm border border-stroke shadow-default dark:border-strokedark dark:bg-boxdark"
  >
    ...
    <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
      <div
        class="relative z-30 mx-auto -mt-40 align-middle h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-4"
      >
        <div class="relative drop-shadow-2">
          <img
            src="@/assets/images/user/user-06.png"
            width="150px"
            height="150px"
            alt="profile"
          />
