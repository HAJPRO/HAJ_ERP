<template>
  <div>
    ...
    <div class="grid grid-cols-3 gap-2">
      <div
        class="col-span-1 xl:col-span-1 bg-white dark:bg-gray-800 shadow-sm rounded-xl"
      >
        <header
        ...
        <div class="p-3">
          ...
          <div>
            ...
            <ul class="my-1">
              ...
              <li class="flex px-2">
                <div
                  class="w-9 h-9 rounded-full shrink-0 bg-gray-200 my-2 mr-3"
                >
                  <svg
                    class="w-9 h-9 fill-current text-gray-400"
                    viewBox="0 0 36 36"
                  >
                    <path
                ...
                >
                  <div class="grow flex justify-between">
                    ...
                    <div class="shrink-0 self-start ml-2">
                      <span
                        class="font-medium text-gray-800 dark:text-gray-100 line-through"
                        >+$99.99</span
                      >
                    </div>
                  </div>
      ...
      >
        <header
          class="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60"
        >
          <h2 class="font-semibold text-gray-800 dark:text-gray-100">Sotuv</h2>
        </header>
        <div class="p-3">
          <!-- Card content -->
          <!-- "Today" group -->
