...
const { items } = storeToRefs(StoreProvide);
</script>
<template>
    <div class="shadow-md rounded min-h-[15px]">
        <el-table load class="w-full" header-align="center" hight="5" empty-text="Mahsulot tanlanmagan... "
            :default-sort="[{ prop: 'duration_time', order: 'descending' }]" :data="items" border style="width: 100%"
            min-height="300" max-height="350">
            <el-table-column header-align="center" align="center" type="index" prop="index" fixed="left" label="№"
                width="80" />
            <el-table-column prop="likra" label="Likra (kg)" width="180" header-align="center" align="center" />
            <el-table-column prop="polister" label="Polister (kg)" width="180" header-align="center" align="center" />
            <el-table-column prop="melaks_yarn" label="Melaks ip" width="200" header-align="center" align="center" />
            <el-table-column prop="yarn_wrap" label="Ipkalava" width="180" header-align="center" align="center" />
            <el-table-column prop="duration_time" sortable label="Yetkazish vaqti" width="180" header-align="center"
                align="center" />
