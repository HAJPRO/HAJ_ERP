    ...
    <div class="shadow-md rounded min-h-[15px]">
        <el-table load class="w-full" header-align="center" hight="5" empty-text="Mahsulot tanlanmagan... "
            ...
            <el-table-column header-align="center" align="center" type="index" prop="index" fixed="left" label="№"
                width="80" />
            <el-table-column prop="latun" label="Latun (kg)" width="250" header-align="center" align="center" />
            <el-table-column prop="begunok" label="Begunok (kg)" width="250" header-align="center" align="center" />
            <el-table-column prop="duration_time" sortable label="Yetkazish vaqti" width="220" header-align="center"
                align="center" />
