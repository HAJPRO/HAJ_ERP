      ...
      <div class="space-y-5">
        ...
        ">
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                <img class="shrink-0 h-8 w-8" viewBox="0 0 24 24"
                  src="https://cdn2.iconfinder.com/data/icons/business-yuk/32/analytic-512.png" alt="package-" />
        ...
        <div>
          <h3 class="text-xs uppercase text-slate-500 font-semibold pl-3">
            ...
            <span class="lg:hidden lg:sidebar-expanded:block 2xl:block">Buyurtmalar</span>
          </h3>
          <ul class="mt-3">
            <!-- Sotuv  -->
        ...
        ">
                <div class="flex items-center justify-between">
                  <div class="flex items-center">
                    <img class="shrink-0 h-7 w-7" viewBox="0 0 24 24"
                      src="https://cdn4.iconfinder.com/data/icons/back-to-school-151/64/file-sheet-document-paper-report-512.png"
                      alt="package-" />
                    <span
                      class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Sotuv
                    </span>
                  </div>
                  <!-- Icon -->
                  <div class="flex shrink-0 ml-2">
        ...
        <div>
          <h3 class="text-xs uppercase text-slate-500 font-semibold pl-3">
            <span class="hidden lg:block lg:sidebar-expanded:hidden 2xl:hidden text-center w-6"
              aria-hidden="true">•••</span>
            <span class="lg:hidden lg:sidebar-expanded:block 2xl:block">Harakatlar</span>
          </h3>
          <ul class="mt-3">
            <!-- Bo'yash harakati  -->
            <SidebarLinkGroup v-slot="parentLink" :activeCondition="currentRoute.fullPath.includes('ecommerce')">
        ...
        ">
                <div class="flex items-center justify-between">
                  <div class="flex items-center">
                    ...
                    <span
                      class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Bo'yash
                      harakati
                    </span>
                  </div>
                  <!-- Icon -->
        ...
        ">
                        <div class="flex items-center justify-between">
                          <div class="flex items-center">
                            <span
                              class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Ishlab
                              chiqarish
                            </span>
                          </div>
                          <!-- Icon -->
                      ...
                      <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul class="mt-1" :class="!parentLink.expanded && 'hidden'">
                          <!-- //Reja iqtisod -->
                          <router-link to="/explore/department/paint/working/plan" custom
        ...
        " :href="href" @click="navigate">
                          ...
                          <!-- // -->
                          <!-- //fipsa -->
                          <router-link to="/explore/products/islabchiqarish/fipsa" custom
                            v-slot="{ href, navigate, isExactActive }">
                            <li class="mb-1 ml-2 last:mb-0">
                              <a class="block transition duration-150 truncate" :class="isExactActive
          ? 'text-[#36d887]'
        ...
        " :href="href" @click="navigate">
                          ...
                          <!-- // -->
                          <!-- //Bo'yoq -->
                          <router-link to="/explore/products/ishlabchiqarish/bo'yoq" custom
                            v-slot="{ href, navigate, isExactActive }">
                            <li class="mb-1 ml-2 last:mb-0">
                              <a class="block transition duration-150 truncate" :class="isExactActive
          ? 'text-[#36d887]'
        ...
        " :href="href" @click="navigate">
                          ...
                          <!-- // -->
                          <!-- //Qurutma-->
                          <router-link to="/explore/products/ishlabciqarish/qurutma" custom
                            v-slot="{ href, navigate, isExactActive }">
                            <li class="mb-1 ml-2 last:mb-0">
                              <a class="block transition duration-150 truncate" :class="isExactActive
          ? 'text-[#36d887]'
        ...
        " :href="href" @click="navigate">
                          ...
                          <!-- // -->
                          <!-- //pechat -->
                          <router-link to="/explore/products/ishlabciqarish/pechat" custom
                            v-slot="{ href, navigate, isExactActive }">
                            <li class="mb-1 ml-2 last:mb-0">
                              <a class="block transition duration-150 truncate" :class="isExactActive
          ? 'text-[#36d887]'
        ...
        " :href="href" @click="navigate">
                          ...
                          <!-- // -->
                          <!-- //Rolik -->
                          <router-link to="/explore/products/ishlabciqarish/rolik" custom
                            v-slot="{ href, navigate, isExactActive }">
                            <li class="mb-1 ml-2 last:mb-0">
                              <a class="block transition duration-150 truncate" :class="isExactActive
          ? 'text-[#36d887]'
        ...
        " :href="href" @click="navigate">
                          ...
                          <!-- // -->
                          <!-- //Tarozi -->
                          <router-link to="/explore/products/ishlabciqarish/tarozi" custom
                            v-slot="{ href, navigate, isExactActive }">
                            <li class="mb-1 ml-2 last:mb-0">
                              <a class="block transition duration-150 truncate" :class="isExactActive
          ? 'text-[#36d887]'
        ...
        " :href="href" @click="navigate">
                          ...
                          <!-- // -->
                          <!-- //Sklad -->
                          <router-link to="/explore/products/ishlabciqarish/skalad" custom
                            v-slot="{ href, navigate, isExactActive }">
                            <li class="mb-1 ml-2 last:mb-0">
                              <a class="block transition duration-150 truncate" :class="isExactActive
          ? 'text-[#36d887]'
        ...
        ">
                <div class="flex items-center justify-between">
                  <div class="flex items-center">
                    ...
                    <span
                      class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">To'quv
                      harakatlari
                    </span>
                  </div>
                  <!-- Icon -->
        ...
        ">
                      ...
                      <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul class="mt-1" :class="!parentLink.expanded && 'hidden'">
                          <!-- //Reja iqtisod to'quv -->
                          <router-link to="/explore/department/weaving/working/plan" custom
                            v-slot="{ href, navigate, isExactActive }">
                            <li class="mb-1 ml-2 last:mb-0">
                              <a class="block transition duration-150 truncate" :class="isExactActive
          ? 'text-[#36d887]'
        ...
        " :href="href" @click="navigate">
                          ...
                          <!-- // -->
                          <router-link to="/explore/products/tuquv/kolsa" custom
                            v-slot="{ href, navigate, isExactActive }">
                            <li class="mb-1 last:mb-0">
                              <a class="block transition duration-150 truncate" :class="isExactActive
          ? 'text-[#36d887]'
        ...
        " :href="href" @click="navigate">
                          ...
                          <!-- // -->
                          <!-- //opela -->
                          <router-link to="/explore/products/tuquv/opelad" custom
                            v-slot="{ href, navigate, isExactActive }">
                            <li class="mb-1 last:mb-0">
                              <a class="block transition duration-150 truncate" :class="isExactActive
          ? 'text-[#36d887]'
        ...
        " :href="href" @click="navigate">
                  ...
                  <!-- Xom mato skaldi -->
                  <router-link to="/explore/products/tikuv/xommato_skladi" custom
                    v-slot="{ href, navigate, isExactActive }">
                    <li class="mb-1 last:mb-0">
                      <a class="block transition duration-150 truncate" :class="isExactActive
          ? 'text-[#36d887]'
        ...
        ">
                <div class="flex items-center justify-between">
                  <div class="flex items-center">
                    ...
                    <span
                      class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Yigiruv
                      harakatlari
                    </span>
                  </div>
                  <!-- Icon -->
        ...
        ">
                      ...
                      <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul class="mt-1" :class="!parentLink.expanded && 'hidden'">
                          <!-- //kolsa -->
                          <!-- //Reja iqtisod to'quv -->
                          <router-link to="/explore/department/spinning/working/plan" custom
                            v-slot="{ href, navigate, isExactActive }">
                            <li class="mb-1 ml-2 last:mb-0">
                              <a class="block transition duration-150 truncate" :class="isExactActive
          ? 'text-[#36d887]'
        ...
        " :href="href" @click="navigate">
                  ...
                  <!-- PAXTA SKLADI -->
                  <router-link to="/explore/products/yigiruv/cotton_sklad" custom
                    v-slot="{ href, navigate, isExactActive }">
                    <li class="mb-1 last:mb-0">
                      <a class="block transition duration-150 truncate" :class="isExactActive
          ? 'text-[#36d887]'
        ...
        " :href="href" @click="navigate">
                  ...
                  <!-- ///< -->
                  <!-- // Ip sklad -->
                  <router-link to="/explore/products/yigiruv/ip_skald" custom
                    v-slot="{ href, navigate, isExactActive }">
                    <li class="mb-1 last:mb-0">
                      <a class="block transition duration-150 truncate" :class="isExactActive
          ? 'text-[#36d887]'
        ...
        ">
                <div class="flex items-center justify-between">
                  <div class="flex items-center">
                    ...
                    <span
                      class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Tikuv
                      harakati
                    </span>
                  </div>
                  <!-- Icon -->
        ...
        ">
                <div class="flex items-center justify-between">
                  <div class="flex items-center">
                    ...
                    <span
                      class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Taminot
                      harakati
                    </span>
                  </div>
                  <!-- Icon -->
              ...
              <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                <ul class="pl-9 mt-1" :class="!parentLink.expanded && 'hidden'">
                  <router-link to="/explore/department/provide/working/plan" custom
                    v-slot="{ href, navigate, isExactActive }">
                    <li class="mb-1 last:mb-0">
                      <a class="block transition duration-150 truncate" :class="isExactActive
          ? 'text-[#36d887]'
        ...
        <div>
          <h3 class="text-xs uppercase text-slate-500 font-semibold pl-3">
            <span class="hidden lg:block lg:sidebar-expanded:hidden 2xl:hidden text-center w-6"
              aria-hidden="true">•••</span>
            <span class="lg:hidden lg:sidebar-expanded:block 2xl:block">Hisobotlar</span>
          </h3>
          <ul class="mt-3">
            <!-- Sklad hisoboti -->
            <SidebarLinkGroup v-slot="parentLink" :activeCondition="currentRoute.fullPath.includes('ecommerce')">
        ...
        <div>
          <h3 class="text-xs uppercase text-slate-500 font-semibold pl-3">
            <span class="hidden lg:block lg:sidebar-expanded:hidden 2xl:hidden text-center w-6"
              aria-hidden="true">•••</span>
            <span class="lg:hidden lg:sidebar-expanded:block 2xl:block">Sozlamalar</span>
          </h3>
          <ul class="mt-3">
            <!-- Admin  -->
            <SidebarLinkGroup v-slot="parentLink" :activeCondition="currentRoute.fullPath.includes('ecommerce')">
        ...
        <div>
          <h3 class="text-xs uppercase text-slate-500 font-semibold pl-3">
            <span class="hidden lg:block lg:sidebar-expanded:hidden 2xl:hidden text-center w-6"
              aria-hidden="true">•••</span>
            <span class="lg:hidden lg:sidebar-expanded:block 2xl:block">Ko'proq</span>
          </h3>
          <ul class="mt-3">
            <!-- Authentication  -->
        ...
        ">
            ...
            <router-link to="/messages" custom v-slot="{ href, navigate, isExactActive }">
              <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0" :class="isExactActive && 'bg-slate-900'">
                <a class="block text-slate-200 truncate transition duration-150" :class="isExactActive ? 'hover:text-slate-200' : 'hover:text-white'
        " :href="href" @click="navigate">
                  <div class="flex items-center justify-between">
                    ...
                    <div class="flex flex-shrink-0 ml-2">
                      <span
                        class="inline-flex items-center justify-center h-5 text-xs font-medium text-white bg-[#6563FF] px-2 rounded">4</span>
                    </div>
                  </div>
                </a>
              </li>
